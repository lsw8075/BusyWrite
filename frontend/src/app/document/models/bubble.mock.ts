...
const c1: Comment = new Comment(1, '1st comment', -1, 2, 1);
const c2: Comment = new Comment(2, '2nd comment', -1, 2, 2);
const c3: Comment = new Comment(3, '3rd comment', -1, 3, 1);
const c4: Comment = new Comment(4, '4th comment', -1, 3, 2);
const c5: Comment = new Comment(5, '5th comment', -1, 3, 3);
const c6: Comment = new Comment(6, '6th comment', -1, 4, 1);
const c7: Comment = new Comment(7, '7th comment', -1, 4, 2);
const c8: Comment = new Comment(8, '8th comment', -2, 5, 1);

const sb1: SuggestBubble = new SuggestBubble(1, '1st suggest bubble', 2);
const sb2: SuggestBubble = new SuggestBubble(2, '2nd suggest bubble', 3);
...
and even other ideas!', 6);
const sb4: SuggestBubble = new SuggestBubble(4, '4th suggest bubble', 7);
const sb5: SuggestBubble = new SuggestBubble(5, 'http://busywrite.ribosome.kr', 3);
...
`<p>If you have troubles using our service check out our FAQ<a href="http://busywrite.ribosome.kr">busywrite FAQ</a></p>`);
  ...
  const b15: InternalBubble = new InternalBubble(15, [16, 17]);
...
Bubbles will help you cherry-pick your own version of the draft.</p>`);
    ...
    const b9: InternalBubble = new InternalBubble(9, [10, 11]);
  const b8: InternalBubble = new InternalBubble(8, [9, 12]);
...
are impractical and unproductive. </p>', -1, [2, 4, 1, 3], [7, 8]);
    const b5: LeafBubble = new LeafBubble(5, '<h5>Introduction</h5>');
  const b4: InternalBubble = new InternalBubble(4, [5, 6, 7], [5], [6]);
