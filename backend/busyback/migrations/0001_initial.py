# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-17 08:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='parent_directory', to='busyback.Document'),
        ),
        migrations.AddField(
            model_name='directory',
            name='owner',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='child_directories', to='busyback.Directory'),
        ),
        migrations.AddField(
            model_name='comment',
            name='bubble',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='busyback.Bubble'),
        ),
        migrations.AddField(
            model_name='comment',
            name='owner',
        ...
        migrations.AddField(
            model_name='normalbubble',
            name='parent_bubble',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='child_bubbles', to='busyback.Bubble'),
        ),
    ]