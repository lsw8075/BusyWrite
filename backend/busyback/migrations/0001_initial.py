# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-12-15 11:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='versions', to='busyback.Document')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edit_lock_holder', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='editing_bubbles', to=settings.AUTH_USER_MODEL)),
                ('owner_with_lock', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='owning_bubbles', to=settings.AUTH_USER_MODEL)),
